...
//
//    double** arr = (double**)malloc(win_size * win_size * win_size * sizeof(double*));
//    for (int ii = 0; ii < win_size * win_size * win_size; ii++) {
//        arr[ii] = (double*)malloc(3 * sizeof(double));
//    }
//
...
//    int a = 1;
//
//    for (int bound_ind = 0; bound_ind < bound_num; bound_ind++) {
//
//        bd.numpoints = 0;
//        int node_list_num = 0;
